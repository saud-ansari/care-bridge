				...
				<div class="wrap-content container" id="container">
					...
					<div class="container-fluid container-fullw bg-white">
						<div class="care-banner">
							...
							<p>Choose a specialization, select your doctor, and confirm your preferred date and time.</p>
						</div>
						<div class="row">
							<div class="col-md-12">
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white care-panel">
											...
											<div class="panel-body">
												<p class="care-alert"><?php echo htmlentities($_SESSION['msg1']); ?>
													<?php echo htmlentities($_SESSION['msg1'] = ""); ?></p>
												<form role="form" name="book" method="post" class="care-form">
