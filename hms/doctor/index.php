						...
						<div class="row" style="margin:0;">
							<div class="col-md-7" style="padding:0;">
								...
								<div class="care-content">
									<h3>Welcome back</h3>
									<p>Manage appointments, view your schedule, and stay connected with your patients.</p>
									...
									<form method="post">
										...
										<div class="care-actions">
											...
											<a class="care-link" href="../user-login.php">Patient login</a>
										</div>
									</form>
							...
							<div class="col-md-5" style="padding:0;">
								<div class="care-illustration">
									<h4>Your clinic, streamlined</h4>
									<p>Stay on top of your day with instant access to appointments, messages, and patient notes.</p>
									<div class="care-badges">
										<span class="care-badge">Schedule Ready</span>
										<span class="care-badge">Secure Records</span>
										<span class="care-badge">Team Support</span>
									</div>
								</div>
							</div>
						</div>
