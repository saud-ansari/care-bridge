						...
						<div class="row" style="margin:0;">
							<div class="col-md-7" style="padding:0;">
								<div class="care-brand">
									...
									<div>
										<h2>Care Bridge</h2>
										<span class="text-muted">Patient Portal</span>
									</div>
								</div>
								<div class="care-content">
									<h3>Welcome back</h3>
									<p>Securely access your appointments, prescriptions, and medical records.</p>
									...
									<form method="post">
										...
										<div class="care-actions">
											...
											<a class="care-link" href="registration.php">Create an account</a>
										</div>
									</form>
							...
							<div class="col-md-5" style="padding:0;">
								<div class="care-illustration">
									<h4>Your care, connected</h4>
									<p>Stay in control of your health journey with instant access to your care team and records.</p>
									<div class="care-badges">
										<span class="care-badge">24/7 Access</span>
										<span class="care-badge">Secure Data</span>
										<span class="care-badge">Expert Doctors</span>
									</div>
								</div>
							</div>
						</div>
